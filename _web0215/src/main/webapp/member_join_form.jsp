        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link active"  href="main_page.jsp" aria-current="page">Home</a>
              </li>
              <li class="nav-item">
    ...
    <div class="container" style="padding-top: 50px;">
        <form action="member_join.jsp">
          <div class="mb-3">
            ...
            <input type="email" name="pw" class="form-control" id="exampleFormControlInput1" placeholder="@example.com">
