	...
	<main class="form-signin w-100 m-auto">
		<form action="login.do" method="post">
			...
			<div class="form-floating">
				<input type="text" name="id" class="form-control" id="floatingidInput" placeholder="Id">
				<label for="floatingidInput">Id</label>
			</div>
			<div class="form-floating">
				<input type="email" name="email" value="<%=email%>" class="form-control" id="floatingemailInput" placeholder="id@example.com">
