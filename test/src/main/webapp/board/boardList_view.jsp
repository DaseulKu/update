...
<form action="view.do" method="post">
	<div class="container" style="padding-top: 50px">
		<div class="mb-3">
			...
			<input type="text" class="form-control" id="titleInput" value="${board.title}">
		</div>
		<div class="mb-3">
			<label for="exampleFormControlTextarea1" class="form-label">Content</label>
			<textarea class="form-control" id="exampleFormControlTextarea1" value="${board.content}" rows="3"></textarea>
		</div>
	</div>
</form>
